...
void OV9655_HW_Init(void) 
{
  ...
  /****** Configures the I2C2 used for OV9655 camera module configuration *****/
 /* I2C2 clock enable */
...
uint8_t OV9655_WriteReg(uint16_t Addr, uint8_t Data)
{
  ...
  I2C_Send7bitAddress(I2C2, OV9655_DEVICE_WRITE_ADDRESS, I2C_Direction_Transmitter);
...
uint8_t OV9655_ReadReg(uint16_t Addr)
{
  ...
  /* Send DCMI selcted device slave Address for write */
  I2C_Send7bitAddress(I2C2, OV9655_DEVICE_READ_ADDRESS, I2C_Direction_Transmitter);
  ...
  /* Send DCMI selcted device slave Address for write */
  I2C_Send7bitAddress(I2C2, OV9655_DEVICE_READ_ADDRESS, I2C_Direction_Receiver);
