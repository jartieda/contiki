				0x88 }, { 0x57, 0x00 }, { 0x5a, 0x90 }, { 0x5b, 0x2c }, { 0x5c,
				0x05 }, { 0xe0, 0x00 }, { 0xd3, 0x04 }, { 0xff, 0x00 }, { 0xc3,
				0xef }, { 0xa6, 0x00 }, { 0xa7, 0xdd }, { 0xa7, 0x78 }, { 0xa7,
				0x7e }, { 0xa7, 0x24 }, { 0xa7, 0x00 }, { 0xa7, 0x25 }, { 0xa6,
				0x06 }, { 0xa7, 0x20 }, { 0xa7, 0x58 }, { 0xa7, 0x73 }, { 0xa7,
				0x34 }, { 0xa7, 0x00 }, { 0xa7, 0x25 }, { 0xa6, 0x0c }, { 0xa7,
				0x28 }, { 0xa7, 0x58 }, { 0xa7, 0x6d }, { 0xa7, 0x34 }, { 0xa7,
				0x00 }, { 0xa7, 0x25 }, { 0xff, 0x00 }, { 0xe0, 0x04 }, { 0xe1,
				0x67 }, { 0xe5, 0x1f }, { 0xd7, 0x01 }, { 0xda, 0x08 }, { 0xda,
				0x09 }, { 0xe0, 0x00 }, { 0x98, 0x00 }, { 0x99, 0x00 }, { 0xff,
				0x01 }, { 0x04, 0x28 }, { 0xff, 0x01 }, { 0x12, 0x40 }, { 0x17,
				...
				0x00 }, { 0x5a, 0x28 }, { 0x5b, 0x1e }, { 0x5c, 0x00 }, { 0xe0,
				0x00 }, { 0xff, 0x01 }, { 0x11, 0x00 }, { 0x3d, 0x38 }, { 0x2d,
				0x00 }, { 0x50, 0x65 }, { 0xff, 0x00 }, { 0xd3, 0x04 }, { 0x7c,
				0x00 }, { 0x7d, 0x04 }, { 0x7c, 0x09 }, { 0x7d, 0x28 }, { 0x7d,
				0x00 }, };

/* QVGA 320x240 */
const unsigned char OV2640_QVGA[][2] = { { 0xff, 0x00 }, { 0x2c, 0xff }, { 0x2e,
		0xdf }, { 0xff, 0x01 }, { 0x3c, 0x32 }, { 0x11, 0x00 }, { 0x09, 0x02 },
		{ 0x04, 0x28 }, { 0x13, 0xe5 }, { 0x14, 0x48 }, { 0x2c, 0x0c }, { 0x33,
...
const unsigned char OV2640_JPEG_INIT[][2] = { { 0xff, 0x00 }, { 0x2c, 0xff }, {
		...
		{ 0x33, 0x78 }, { 0x3a, 0x33 }, { 0x3b, 0xfB }, { 0x3e, 0x00 }, { 0x43,
				...
				0xC8 }, { 0x5b, 0x96 }, { 0x5c, 0x00 }, { 0xd3, 0x7f }, { 0xc3,
				0xed }, { 0x7f, 0x00 }, { 0xda, 0x00 }, { 0xe5, 0x1f }, { 0xe1,
				0x67 }, { 0xe0, 0x00 }, { 0xdd, 0x7f }, { 0x05, 0x00 },

		{ 0x12, 0x40 }, { 0xd3, 0x7f }, { 0xc0, 0x16 }, { 0xC1, 0x12 }, { 0x8c,
...
/* JPG, 0x176x144 */
const unsigned char OV2640_176x144_JPEG[][2] = { { 0xff, 0x01 }, { 0x12, 0x40 },
		{ 0x17, 0x11 }, { 0x18, 0x43 }, { 0x19, 0x00 }, { 0x1a, 0x4b }, { 0x32,
				0x09 }, { 0x4f, 0xca }, { 0x50, 0xa8 }, { 0x5a, 0x23 }, { 0x6d,
				0x00 }, { 0x39, 0x12 }, { 0x35, 0xda }, { 0x22, 0x1a }, { 0x37,
				0xc3 }, { 0x23, 0x00 }, { 0x34, 0xc0 }, { 0x36, 0x1a }, { 0x06,
...
/* JPG 352x288 */
const unsigned char OV2640_352x288_JPEG[][2] = { { 0xff, 0x01 }, { 0x12, 0x40 },
		{ 0x17, 0x11 }, { 0x18, 0x43 }, { 0x19, 0x00 }, { 0x1a, 0x4b }, { 0x32,
				0x09 }, { 0x4f, 0xca }, { 0x50, 0xa8 }, { 0x5a, 0x23 }, { 0x6d,
				0x00 }, { 0x39, 0x12 }, { 0x35, 0xda }, { 0x22, 0x1a }, { 0x37,
				0xc3 }, { 0x23, 0x00 }, { 0x34, 0xc0 }, { 0x36, 0x1a }, { 0x06,
				...
				0x4b }, { 0x86, 0x35 }, { 0x50, 0x89 }, { 0x51, 0xc8 }, { 0x52,
				0x96 }, { 0x53, 0x00 }, { 0x54, 0x00 }, { 0x55, 0x00 }, { 0x57,
				0x00 }, { 0x5a, 0x58 }, { 0x5b, 0x48 }, { 0x5c, 0x00 }, { 0xe0,
				0x00 }, };
...
void OV2640_HW_Init(void) {
	...
	RCC_AHB1PeriphClockCmd(
			RCC_AHB1Periph_GPIOA | RCC_AHB1Periph_GPIOB | RCC_AHB1Periph_GPIOE,
			ENABLE);
...
void OV2640_Init(ImageFormat_TypeDef ImageFormat) {
	...
	DMA_InitStructure.DMA_BufferSize = 120*80;//120*160/2
...
void OV2640_JPEGConfig(ImageFormat_TypeDef ImageFormat) {
	...
	case JPEG_160x120: {
		for (i = 0; i < (sizeof(OV2640_160x120_JPEG) / 2); i++) {
			OV2640_WriteReg(OV2640_160x120_JPEG[i][0],
					OV2640_160x120_JPEG[i][1]);
		}
		break;
	}
	case JPEG_176x144: {
		for (i = 0; i < (sizeof(OV2640_176x144_JPEG) / 2); i++) {
			OV2640_WriteReg(OV2640_176x144_JPEG[i][0],
					OV2640_176x144_JPEG[i][1]);
		}
		break;
	}
	case JPEG_320x240: {
		for (i = 0; i < (sizeof(OV2640_320x240_JPEG) / 2); i++) {
			OV2640_WriteReg(OV2640_320x240_JPEG[i][0],
	...
	case JPEG_352x288: {
		for (i = 0; i < (sizeof(OV2640_352x288_JPEG) / 2); i++) {
			OV2640_WriteReg(OV2640_352x288_JPEG[i][0],
					OV2640_352x288_JPEG[i][1]);
		}
		break;
	}
	default: {
...
uint8_t OV2640_WriteReg(uint16_t Addr, uint8_t Data) {
	...
	I2C_Send7bitAddress(I2C2, OV2640_DEVICE_WRITE_ADDRESS,
...
uint8_t OV2640_ReadReg(uint16_t Addr) {
	...
	/* Send DCMI selcted device slave Address for write */
	I2C_Send7bitAddress(I2C2, OV2640_DEVICE_READ_ADDRESS,
			I2C_Direction_Transmitter);
	...
	/* Clear AF flag if arised */I2C2->SR1 |= (uint16_t) 0x0400;
