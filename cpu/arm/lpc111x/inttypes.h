#ifndef __INITTYPES_H__
#define __INITTYPES_H__
...
typedef    unsigned  long long  *  unit64_ptr;
...
#define	LD_WORD_BE(ptr)			(WORD)(((WORD)*(volatile BYTE*)((ptr)+0)<<8)|(WORD)*(volatile BYTE*)((ptr)+1))
#define	LD_DWORD_BE(ptr)		(DWORD)(((DWORD)*(volatile BYTE*)((ptr)+0)<<24)|((DWORD)*(volatile BYTE*)((ptr)+1)<<16)|((WORD)*(volatile BYTE*)((ptr)+2)<<8)|*(volatile BYTE*)((ptr)+3))
#define	ST_WORD_BE(ptr,val)		*(volatile BYTE*)((ptr)+1)=(BYTE)(val); *(volatile BYTE*)((ptr))=(BYTE)((WORD)(val)>>8)
#define	ST_DWORD_BE(ptr,val)	*(volatile BYTE*)((ptr)+3)=(BYTE)(val); *(volatile BYTE*)((ptr)+2)=(BYTE)((WORD)(val)>>8); *(volatile BYTE*)((ptr)+1)=(BYTE)((DWORD)(val)>>16); *(volatile BYTE*)((ptr)+0)=(BYTE)((DWORD)(val)>>24)
